...
const BUTTON_STYLES = {
  base: 'group mt-3 flex w-fit items-center justify-center rounded-xl bg-surface-tertiary/70 hover:bg-beigetertiaryhover/60 px-3 py-2 text-xs leading-[18px] animate-thinking-appear',
