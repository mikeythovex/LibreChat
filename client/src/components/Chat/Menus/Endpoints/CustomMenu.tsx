    ...
    <Ariakit.MenuProvider store={menuStore} values={values} setValues={onValuesChange}>
      <Ariakit.MenuButton
        ...
        className={cn(
          ...
          !parent &&
            'bg-surface-primary hover:bg-surface-tertiary flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-border-light px-3 py-2 text-sm text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white',
          props.className,
        )}
