    ...
    <ToggleContext.Provider value={{ isPopoverActive, setPopoverActive }}>
      <div
        ...
        className={cn(
          ...
          isActiveConvo
            ? 'from-gray-50 from-85% to-transparent group-hover:bg-beige4 group-hover:from-gray-200 dark:from-gray-800 dark:group-hover:from-gray-800'
            : 'z-50 from-gray-50 from-0% to-transparent hover:bg-beige4 group-hover:from-gray-200 dark:from-gray-800 dark:group-hover:from-gray-800',
