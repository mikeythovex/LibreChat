  ...
  return (
    <Select.SelectProvider>
      <Select.Select
        ...
        className="mt-text-sm flex h-auto w-full items-center gap-2 rounded-xl p-2 text-sm transition-all duration-200 ease-in-out hover:bg-beigetertiary hover:dark:bg-darkbeige800"
      >
