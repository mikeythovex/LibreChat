...
export default function NewChat({
  ...
  return (
    <div className="sticky left-0 right-0 top-0 z-50 bg-beigesecondary pt-3.5 dark:bg-darkbeige">
      {/* <div className="pb-0.5 last:pb-0" style={{ transform: 'none' }}>
        <a
          ...
          className={cn(
            'group flex h-10 items-center gap-2 rounded-lg px-2 border border-beige400 font-medium transition-colors duration-200 hover:bg-beigetertiary',
            isSmallScreen ? 'h-14' : '',
          )}
