...
export default function MobileNav({
  ...
  return (
    <div className="bg-token-main-surface-primary sticky top-0 z-10 flex min-h-[40px] items-center justify-center bg-surface-secondary pl-1 dark:bg-gray-800 dark:text-white md:hidden">
      <button
        type="button"
      ...
      <h1 className="text-md flex-1 translate-y-0.5 overflow-hidden text-ellipsis whitespace-nowrap text-center font-semibold">
      ...
      >
        {/* TODO: Factor into claude icon */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="55.96 40.94 67.99 68.02"
          fill="currentColor"
        >
