    ...
    <div className={cn('relative', className)}>
      <Select.Select
        ...
        className={cn(
          ...
          'focus:ring-offset-ring-offset relative inline-flex items-center justify-between rounded-xl border border-input bg-background px-3 py-2 text-sm text-text-primary transition-all duration-200 ease-in-out hover:bg-surface-tertiary hover:dark:bg-darkbeige800 hover:text-accent-foreground focus:ring-ring-primary',
